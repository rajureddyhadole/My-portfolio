...
import resume from "../assets/Raju's-resume.pdf"
  ...
  return (
    <div className='flex w-full flex-col justify-between h-[90vh]'>
      <div className='flex flex-col items-center justify-center gap-8 md:mt-10 lg:mt-20'>
        <h1 className='mt-8 text-4xl font-semibold sm:text-5xl text-neutral-300'
        >About me</h1>
        ...
        <a className='px-12 py-3 mt-4 text-lg font-semibold rounded-full bg-gradient-to-r from-orange-600 to-orange-800 text-neutral-900' href={resume} download="Raju's resume">Resume</a>
      </div>
      <Footer />
    </div>
  )
