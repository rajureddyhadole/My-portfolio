  ...
  return (
    <div className='flex flex-col justify-between h-[91vh]'>
      <div className='flex flex-col items-center justify-center gap-10 sm:mt-10'>
        ...
        <a className='px-12 py-3 mt-10 text-lg font-semibold rounded-full bg-gradient-to-r from-orange-600 to-orange-800 text-neutral-900' href='images/My Resume.pdf' download="Raju's resume">Resume</a>
      </div>
      <Footer />
    </div>
  )
